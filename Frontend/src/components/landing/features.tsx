          ...
          {features.map((feature, index) => {
            ...
            return (
              <motion.div
                ...
                viewport={{ once: true }}
                className="group relative rounded-xl border border-border bg-card p-6 hover:border-primary/30 hover:theme-glow-subtle transition-all duration-300 card-hover"
              >
